...
![](../figures/github-repo.png){fig-align="center"}
...
That's it! You now have a project environment managed by `uv` and can go ahead and run Python code

For example, using data from [github.com/marcdotson/pydata-uv](https://github.com/marcdotson/pydata-uv), replace the code in `main.py` with the following
...
Then run `uv run python main.py` from the command line

## Other details

You'll probably be using a code editor (i.e., [VS Code](https://code.visualstudio.com), [Cursor](https://cursor.com), [Positron](https://posit.co/products/ide/positron/), etc.), and you'll have to make sure you open the project directory (i.e., `uv-practice`) in the code editor and make sure the code editor **activates the project environment**
...
::: {.fragment}
There's a *lot* more that [uv](https://docs.astral.sh/uv/) can do
:::
